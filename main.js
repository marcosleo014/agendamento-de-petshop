...
/***/ "./src/scripts/api/add-schedule.js"
/*!*****************************************!*\
  !*** ./src/scripts/api/add-schedule.js ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   postSchedule: () => (/* binding */ postSchedule)\n/* harmony export */ });\n/* harmony import */ var _toast_notification__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../toast-notification */ \"./src/scripts/toast-notification.js\");\n/* harmony import */ var _api_configurations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api-configurations */ \"./src/scripts/api/api-configurations.js\");\n\r\n\r\n\r\nasync function postSchedule(scheduleObj) {\r\n    try {\r\n        await fetch(`${_api_configurations__WEBPACK_IMPORTED_MODULE_1__.apiConfig.baseURL}/schedules`, {\r\n            method: 'POST',\r\n            headers: {\r\n                \"Content-Type\": \"application/json\"\r\n            },\r\n            body: JSON.stringify(scheduleObj)\r\n        });\r\n        (0,_toast_notification__WEBPACK_IMPORTED_MODULE_0__.toastMsg)('Agendamento realizado com sucesso!')\r\n    } catch (error) {\r\n        console.log(error);\r\n        (0,_toast_notification__WEBPACK_IMPORTED_MODULE_0__.toastMsg)('Erro ao realizar o agendamento!');\r\n        throw error\r\n    };\r\n};\n\n//# sourceURL=webpack:///./src/scripts/api/add-schedule.js?\n}");

/***/ },

/***/ "./src/scripts/api/api-configurations.js"
/*!***********************************************!*\
  !*** ./src/scripts/api/api-configurations.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   apiConfig: () => (/* binding */ apiConfig)\n/* harmony export */ });\nconst apiConfig = {\r\n    baseURL: 'http://localhost:3333'\r\n}\n\n//# sourceURL=webpack:///./src/scripts/api/api-configurations.js?\n}");

/***/ },

/***/ "./src/scripts/api/delete-schedule.js"
/*!********************************************!*\
  !*** ./src/scripts/api/delete-schedule.js ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   deleteSchedule: () => (/* binding */ deleteSchedule)\n/* harmony export */ });\n/* harmony import */ var _toast_notification__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../toast-notification */ \"./src/scripts/toast-notification.js\");\n/* harmony import */ var _api_configurations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api-configurations */ \"./src/scripts/api/api-configurations.js\");\n\r\n\r\n\r\nasync function deleteSchedule(id) {\r\n    try {\r\n        await fetch(`${_api_configurations__WEBPACK_IMPORTED_MODULE_1__.apiConfig.baseURL}/schedules/${id}`, {\r\n            method: 'DELETE'\r\n        });\r\n        (0,_toast_notification__WEBPACK_IMPORTED_MODULE_0__.toastMsg)('Agendamento cancelado!')\r\n    } catch (error) {\r\n        console.log(error);\r\n        (0,_toast_notification__WEBPACK_IMPORTED_MODULE_0__.toastMsg)('Erro ao cancelar o agendamento!');\r\n        throw error\r\n    }\r\n};\n\n//# sourceURL=webpack:///./src/scripts/api/delete-schedule.js?\n}");

/***/ },

/***/ "./src/scripts/api/get-schedules.js"
/*!******************************************!*\
  !*** ./src/scripts/api/get-schedules.js ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getSchedules: () => (/* binding */ getSchedules)\n/* harmony export */ });\n/* harmony import */ var _toast_notification_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../toast-notification.js */ \"./src/scripts/toast-notification.js\");\n/* harmony import */ var _api_configurations_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api-configurations.js */ \"./src/scripts/api/api-configurations.js\");\n\r\n\r\n\r\nasync function getSchedules() {\r\n    try {\r\n        const response = await fetch(`${_api_configurations_js__WEBPACK_IMPORTED_MODULE_1__.apiConfig.baseURL}/schedules`);\r\n        const data = await response.json();\r\n        return data;\r\n    } catch(error) {\r\n        console.log(error);\r\n        (0,_toast_notification_js__WEBPACK_IMPORTED_MODULE_0__.toastMsg)('Erro ao se conectar com o servidor!')\r\n        throw error\r\n    }// removed by dead control flow\n\r\n};\n\n//# sourceURL=webpack:///./src/scripts/api/get-schedules.js?\n}");
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   deleteScheduleById: () => (/* binding */ deleteScheduleById),\n/* harmony export */   loadSchedules: () => (/* binding */ loadSchedules),\n/* harmony export */   schedules: () => (/* binding */ schedules)\n/* harmony export */ });\n/* harmony import */ var _api_delete_schedule__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/delete-schedule */ \"./src/scripts/api/delete-schedule.js\");\n/* harmony import */ var _api_get_schedules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../api/get-schedules */ \"./src/scripts/api/get-schedules.js\");\n/* harmony import */ var _toast_notification__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../toast-notification */ \"./src/scripts/toast-notification.js\");\n\r\n\r\n\r\n\r\nlet schedules;\r\n\r\nasync function loadSchedules() {\r\n    try {\r\n        schedules = await (0,_api_get_schedules__WEBPACK_IMPORTED_MODULE_1__.getSchedules)();\r\n    } catch (error) {\r\n        schedules = [];\r\n        console.log(error);\r\n        (0,_toast_notification__WEBPACK_IMPORTED_MODULE_2__.toastMsg)('Erro ao obter agendamentos!')\r\n    }\r\n};\r\n\r\nasync function deleteScheduleById(id) {\r\n    try {\r\n        await (0,_api_delete_schedule__WEBPACK_IMPORTED_MODULE_0__.deleteSchedule)(id);\r\n        schedules = schedules.filter(scheduleObj => scheduleObj.id != id);\r\n    } catch (error) {\r\n        console.log(error);\r\n        throw error;\r\n    }\r\n};\n\n//# sourceURL=webpack:///./src/scripts/schedule-operations/schedules.js?\n}");
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _verify_empty_msg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../verify-empty-msg */ \"./src/scripts/verify-empty-msg.js\");\n/* harmony import */ var _switch_screen_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../switch-screen.js */ \"./src/scripts/switch-screen.js\");\n/* harmony import */ var _delete_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./delete.js */ \"./src/scripts/schedule-operations/delete.js\");\n/* harmony import */ var _create_schedules_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./create-schedules.js */ \"./src/scripts/schedule-operations/create-schedules.js\");\n/* harmony import */ var _schedules_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./schedules.js */ \"./src/scripts/schedule-operations/schedules.js\");\n/* harmony import */ var _api_add_schedule_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../api/add-schedule.js */ \"./src/scripts/api/add-schedule.js\");\n/* harmony import */ var _toast_notification_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../toast-notification.js */ \"./src/scripts/toast-notification.js\");\n/* harmony import */ var _inputs_value_default_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./inputs-value-default.js */ \"./src/scripts/schedule-operations/inputs-value-default.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst form = document.querySelector('.schedule-form');\r\n\r\nform.onsubmit = async (event) => {\r\n    event.preventDefault();\r\n    \r\n    // obtendo os elemento do DOM\r\n    const client = document.querySelector('#name-client');\r\n    const pet = document.querySelector('#name-pet');\r\n    const phone = document.querySelector('#telephone');\r\n    const description = document.querySelector('#service-description');\r\n    const date = document.querySelector('#date');\r\n    const hour = document.querySelector('#hour');\r\n\r\n    // Tratando os valores dos inputs\r\n    if (!client.value.trim()) {\r\n        client.value = '';\r\n        (0,_toast_notification_js__WEBPACK_IMPORTED_MODULE_6__.toastMsg)('Identifique o tutor do pet');\r\n        return\r\n    }\r\n    if (!pet.value.trim()) {\r\n        pet.value = '';\r\n        (0,_toast_notification_js__WEBPACK_IMPORTED_MODULE_6__.toastMsg)('Insira o nome do pet');\r\n        return\r\n    }\r\n    if (phone.value.length < 15) {\r\n        (0,_toast_notification_js__WEBPACK_IMPORTED_MODULE_6__.toastMsg)('Número de telefone inválido');\r\n        return\r\n    }\r\n    if (!description.value.trim()) {\r\n        (0,_toast_notification_js__WEBPACK_IMPORTED_MODULE_6__.toastMsg)('Adicione a descrição do serviço');\r\n        return\r\n    }\r\n    if (!hour.value) {\r\n        (0,_toast_notification_js__WEBPACK_IMPORTED_MODULE_6__.toastMsg)('Selecione um horário')\r\n        return\r\n    }\r\n\r\n    // objeto que armazena dados do agendamento\r\n    const scheduleObj = {\r\n        id: Date.now().toString(),\r\n        client: client.value.trim(),\r\n        pet: pet.value.trim(),\r\n        phone: phone.value,\r\n        description: description.value.trim(),\r\n        date: date.value,\r\n        hour: Number(hour.value)\r\n    };\r\n\r\n    try {\r\n        await (0,_api_add_schedule_js__WEBPACK_IMPORTED_MODULE_5__.postSchedule)(scheduleObj);\r\n        \r\n        (0,_create_schedules_js__WEBPACK_IMPORTED_MODULE_3__.addScheduleElement)(scheduleObj);\r\n        (0,_switch_screen_js__WEBPACK_IMPORTED_MODULE_1__.openScheduleForm)(false);\r\n        (0,_delete_js__WEBPACK_IMPORTED_MODULE_2__.addEventScheduleCancel)();\r\n\r\n        // reseta o form e define a data para a atual\r\n        form.reset();\r\n        date.value = _inputs_value_default_js__WEBPACK_IMPORTED_MODULE_7__.dataNow;\r\n        // Inserir o agendamento no array de agendamentos\r\n        _schedules_js__WEBPACK_IMPORTED_MODULE_4__.schedules.push(scheduleObj);\r\n    } catch (error) {\r\n        console.log(error);\r\n    };\r\n};\n\n//# sourceURL=webpack:///./src/scripts/schedule-operations/submit.js?\n}");
